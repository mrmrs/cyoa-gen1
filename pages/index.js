...
const curated = [
  ...
  ['#1D2B53', '#7E2553', '#008751', '#AB5236', '#5F574F', '#C2C3C7', '#FFF1E8', '#FF004D', '#FFA300', '#FFEC27', '#00E436', '#29ADFF', '#83769C', '#FF77A8', '#FFCCAA', '#000000' ],
  ...
  ['#626262', '#898989', '#adadad', '#ffffff', '#9f4e44', '#cb7e75', '#6d5412', '#a1683c', '#c9d487', '#9ae29b', '#5cab5e', '#6abfc6', '#887ecb', '#50459b', '#a057a3','#000000',],
  ...
  ['#7e7e7e', '#bebebe', '#ffffff', '#7e0000', '#fe0000', '#047e00', '#06ff04', '#7e7e00', '#ffff04', '#00007e', '#0000ff', '#7e007e', '#fe00ff', '#047e7e', '#06ffff', '#000000',],
  ['#699fad', '#3a708e', '#2b454f', '#111215', '#151d1a', '#1d3230', '#314e3f', '#4f5d42', '#9a9f87', '#ede6cb', '#f5d893', '#e8b26f', '#b6834c', '#704d2b', '#40231e', '#151015',],
  ['#555555', '#aaaaaa', '#ffffff', '#0000aa', '#5555ff', '#00aa00', '#55ff55', '#00aaaa', '#55ffff', '#aa0000', '#ff5555', '#aa00aa', '#ff55ff', '#aa5500', '#ffff55', '#000000',],
  ...
  ['#001418', '#002024', '#002c38', '#143444', '#443444', '#583c48', '#6c4c44', '#806058', '#6c706c', '#888078', '#a49484', '#c4ac9c', '#d8b0a8', '#ecd4d0', '#fcfcfc', '#000000',],
  ...
  ['#4a4a4a', '#7b7b7b', '#b2b2b2', '#ffffff', '#813338', '#c46c71', '#553800', '#8e5029', '#edf171', '#a9ff9f', '#56ac4d', '#75cec8', '#706deb', '#2e2c9b', '#8e3c97', '#000000',],
  ['#320011', '#5f3a60', '#876672', '#b7a39d', '#ece8c2', '#6db7c3', '#5e80b2', '#627057', '#8da24e', '#d2cb3e', '#f7d554', '#e8bf92', '#e78c5b', '#c66f5e', '#c33846', '#933942',],
  ['#191028', '#46af45', '#a1d685', '#453e78', '#7664fe', '#833129', '#9ec2e8', '#dc534b', '#e18d79', '#d6b97b', '#e9d8a1', '#216c4b', '#d365c8', '#afaab9', '#f5f4eb', '#000000',],
  ...
  ['#181818', '#282828', '#383838', '#474747', '#565656', '#646464', '#717171', '#7e7e7e', '#8c8c8c', '#9b9b9b', '#ababab', '#bdbdbd', '#d1d1d1', '#e7e7e7', '#ffffff', '#000000',],
  ...
  ['#493c2b', '#be2633', '#e06f8b', '#9d9d9d', '#a46422', '#eb8931', '#f7e26b', '#ffffff', '#1b2632', '#2f484e', '#44891a', '#a3ce27', '#005784', '#31a2f2', '#b2dcef', '#000000',],
  ...
  ['#af3f52', '#5f3959', '#2e2937', '#905c9a', '#d78d42', '#93593b', '#8d92ac', '#d47fb0', '#dddd50', '#75b546', '#4a6db2', '#f3cb94', '#eff0e9', '#a7d6da', '#56a1c8','#0c0b0f',],
  ['#68605c', '#b0b0b8', '#fcfcfc', '#1c38ac', '#7070fc', '#a82814', '#fc4848', '#208800', '#70f828', '#b82cd0', '#fc74ec', '#ac581c', '#f8a850', '#3cd4e4', '#f8ec20','#000000',],
  ['#4e53a2', '#7394ba', '#e6e1cc', '#28524e', '#3a7e4c', '#7da446', '#edd15a', '#4b1d45', '#8c315d', '#cf4f4f', '#f6788d', '#6a5154', '#a45a41', '#d87e46', '#b49a8d','#2e1b37',],
  ['#f1d29e', '#b58c6e', '#6b4a41', '#3b2422', '#665953', '#a39d77', '#ebdc6c', '#d9903d', '#a7512d', '#6b2727', '#3b1b23', '#170f0d', '#1e2f27', '#51634d', '#9dba6c','#fffdda',],
  ['#697594', '#dfe9f5', '#f7aaa8', '#d4689a', '#782c96', '#e83562', '#f2825c', '#ffc76e', '#88c44d', '#3f9e59', '#373461', '#4854a8', '#7199d9', '#9e5252', '#4d2536','#0a080d',],
  ['#90B0B0', '#FFFFFF', '#800018', '#FF0000', '#A05000', '#FF8000', '#FFC080', '#FFFF00', '#20AC00', '#40FF00', '#003070', '#3070B0', '#00D0FF', '#A000E0', '#FF60FF','#000000',],
  ['#3c351f', '#313390', '#1559db', '#a73211', '#d85525', '#a15589', '#cd7a50', '#629a31', '#9cd33c', '#28a4cb', '#65dcd6', '#e8bc50', '#f1e782', '#bfbfbd', '#f2f1ed','#000000',],
  ['#75ceea', '#317ad7', '#283785', '#1a1b35', '#2e354e', '#4f6678', '#a4bcc2', '#ecf860', '#94d446', '#3b7850', '#20322e', '#512031', '#a43e4b', '#dc7d5e', '#f0cc90','#ffffff',],
  ['#383730', '#665f57', '#82857b', '#b1b8a9', '#dee6b8', '#95bdb2', '#5a7b85', '#273245', '#477a5a', '#81ba78', '#d4ea92', '#b59766', '#8f5450', '#66403c', '#40292f','#0b0d0a',],
  ['#4c898b', '#0e3e5b', '#15894c', '#95ce56', '#eeee77', '#f7a046', '#d64b33', '#5a340e', '#b05670', '#ffad93', '#ffffff', '#acaaac', '#626562', '#000000', '#ad601a','#95cecd',],
  ['#566262', '#8d8d85', '#a7b5ba', '#f0e9cf', '#d39f80', '#b0703e', '#5a4142', '#d1d15b', '#a7d254', '#58a23c', '#7ac2e0', '#786aff', '#3e489d', '#8363ad', '#c14867','#0b0b0b',],
  ['#333025', '#585e53', '#a5a589', '#eae5d1', '#dec666', '#97ab50', '#516b38', '#25150f', '#522732', '#9c323c', '#c4663d', '#e48d80', '#6392af', '#2c3c6a', '#2c1d34','#100a0a',],
  ...
  ['#5e606e', '#2234d1', '#4c81fb', '#0c7e45', '#6cd947', '#44aacc', '#7be2f9', '#8a3622', '#eb8a60', '#5c2e78', '#e23d69', '#aa5c3d', '#ffd93f', '#b5b5b5', '#ffffff', '#000000',],
  ['#1b3e3c', '#3e5b51', '#6e7e55', '#a9a96b', '#ffe1cb', '#ffc190', '#ffb54a', '#ff8837', '#ff5d00', '#ba4509', '#902200', '#4e0d00', '#dd2200', '#ff4e1d', '#ffffff', '#000000',],
  ...
  ['#291a13', '#724c30', '#b68c56', '#fff0a0', '#463007', '#755a0b', '#ab811d', '#5e260e', '#a1430f', '#ff8b18', '#f6bf3a', '#552012', '#9a361e', '#eb5731', '#ee9852', '#000000',],
...
export default function Home() {
  ...
  const [stdDeviation, setStdDeviation] = useState(randomInt(0,90))
  const [edgeMode, setEdgeMode] = useState(sample(['wrap', 'none', 'duplicate']))
  ...
  const [radGradient,setRadGradient] = useState('url(#RadGradient'+randomInt(0,15)+')')
  ...
  const regenerateClick = () => {
    ...
    setGradient2('url(#Gradient'+randomInt(0,15)+')')
    setRadGradient('url(#RadGradient'+randomInt(0,15)+')')
  ...
  return (
    <>
      <Head>
        ...
        <link rel="icon" href="https://mrmrs.cc/favicon.ico" />
    ...
    <svg id='canvas' height={height} viewBox={'0 0 '+width+ ' '+height} width={width} style={{ transition: 'all 1s ease-in', zIndex: -9, background: generatedDesignCount < 1? 'white': bgColor, minHeight: '100%', minWidth: '100%',}}>
      ...
      <g style={{ filter : generatedDesignCount % 9 === 0 ? 'url(#blurMe)' : 'none'}}>
      ...
      {generatedDesignCount === 16 &&
          <line x1={width/2} x2={width/2} y1={128} y2={height - 128} stroke={bgColor} strokeWidth={strokeWidth + 4} />
      }
      {generatedDesignCount === 17 &&
          <>
          <line x1={width/2} x2={width/2} y1={height/3} y2={height/3*2} stroke={bgColor} strokeWidth={strokeWidth + 4} />
          <line x1={width/2+16} x2={width/2+16} y1={height/3} y2={height/3*2} stroke={bgColor} strokeWidth={strokeWidth + 4} />
          <line x1={width/2-16} x2={width/2-16} y1={height/3} y2={height/3*2} stroke={bgColor} strokeWidth={strokeWidth + 4} />
          </>
      }
      {generatedDesignCount === 18 &&
          <>
          <line x1={width/2} x2={width/2} y1={128} y2={height - 128} stroke={bgColor} strokeWidth={strokeWidth + 1} />
          <line x1={width/2+16} x2={width/2+16} y1={128} y2={height - 128} stroke={bgColor} strokeWidth={strokeWidth + 1} />
          <line x1={width/2-16} x2={width/2-16} y1={128} y2={height - 128} stroke={bgColor} strokeWidth={strokeWidth + 1} />
          <line x1={width/2+32} x2={width/2+32} y1={128} y2={height - 128} stroke={bgColor} strokeWidth={strokeWidth + 1} />
          <line x1={width/2-32} x2={width/2-32} y1={128} y2={height - 128} stroke={bgColor} strokeWidth={strokeWidth + 1} />
          </>
      }
    ...
    <svg height='0' width='0' style={{ height: 0, width: 0, display: 'block'}}>
      <defs>
        ...
        <radialGradient id='RadGradient0' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[0]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient1' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[1]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]} />
        </radialGradient>
        <radialGradient id='RadGradient2' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[2]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient3' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[3]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient4' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[4]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient5' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[5]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient6' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[6]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient7' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[7]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient8' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[8]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient9' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[9]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient10' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[10]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient11' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[11]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient12' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[12]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient13' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[13]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient14' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[14]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient15' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[15]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
        <radialGradient id='RadGradient16' x1='0' x2='0' y1='0' y2='1'>
          <stop offset='0%' stopColor={palette[randomInt(0,15)]}  />
          <stop offset='100%' stopColor={palette[randomInt(0,15)]}  />
        </radialGradient>
  ...
  <filter id="displacementFilter">
    ...
    <feDisplacementMap
      ...
      yChannelSelector={channelY} />
        ...
        <filter id="blurMe">
          <feGaussianBlur in="SourceImage" stdDeviation={stdDeviation} edgeMode={edgeMode}/>
        </filter>
      </defs>
    </svg>    
    }
   <kbd style={{ fontSize: '14px', fontFamily: 'monospace', lineHeight: 1.0, padding: '8px 12px', color: 'white', background: 'black', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'absolute', top: 0, right: 0,  }}>{generatedDesignCount}</kbd> 
    <footer style={{ position: 'absolute', bottom: 0, left: 0, right: 0, background: 'transparent', padding: '16px', display: 'flex', justifyContent: 'center', gap: '2rem', userSelect: 'none' }}>
