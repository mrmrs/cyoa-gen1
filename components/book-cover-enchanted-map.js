...
const EnchantedBookCover = ({ colors, bgColor, color = 'red', fill = 'transparent', maxLimit = randomInt(50,150), strokeWidth = randomInt(2,16)}) => {
    ...
    return (
      ...
      <svg viewBox={'0 0 '+width+' '+height}  stroke='white' width='1000' height='1410' style={{ padding: '48px', transition: 'all .5s ease-in', backgroundBlendMode: 'overlay', backgroundColor: 'rgba(220,220,24,.9)',  mixBlendMode: 'overlay', overflow: 'visible', display: 'block', width: '100%', height: 'auto' }}>
      <rect 
